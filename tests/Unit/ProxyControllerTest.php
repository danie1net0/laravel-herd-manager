...
describe('ProxyController', function () {
    ...
    describe('list', function () {
        it('retorna lista de proxies em JSON', function () {
    ...
    describe('create', function () {
        it('retorna erro 400 para nome vazio', function () {
        ...
        it('retorna erro 400 para porta inválida', function () {
            $request = $this->psr17Factory->createServerRequest('POST', '/api/proxies')
        ...
        it('retorna erro 400 para formato de nome inválido', function () {
            $request = $this->psr17Factory->createServerRequest('POST', '/api/proxies')
    ...
    describe('delete', function () {
        ...
        it('retorna erro 404 para proxy não encontrado', function () {
    ...
    describe('HTTP Status Codes', function () {
        it('usa código 200 para listagem', function () {
            $request = $this->psr17Factory->createServerRequest('GET', '/api/proxies');
            $response = $this->controller->list($request);
            expect($response->getStatusCode())->toBe(200);
        });

        it('usa código 400 para bad request', function () {
            $request = $this->psr17Factory->createServerRequest('POST', '/api/proxies')
        ...
        it('usa código 404 para recurso não encontrado', function () {
            $request = $this->psr17Factory->createServerRequest('DELETE', '/api/proxies/non-existent');
    ...
    describe('JSON Response Format', function () {
        it('sempre retorna JSON válido na listagem', function () {
            $request = $this->psr17Factory->createServerRequest('GET', '/api/proxies');
            $response = $this->controller->list($request);
        ...
        it('sempre retorna JSON válido em erros', function () {
            $request = $this->psr17Factory->createServerRequest('POST', '/api/proxies')
